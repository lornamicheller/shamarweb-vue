  ...
  <div>
    ...
    <div class="container-fluid profile-component">
      <div class="card profile-component">
        <img class="profile-image" :src="(user.foto != null) ? (user.foto.url) : '../assets/logo-shamar.png'">
        <div class="profile-info">
          <p class="profile-name">{{user.username}}</p>
          <p class="country-name">{{user.country}}</p>
          <div class="ratings">
            <img src="../assets/sishamar.png" width="25px" height="25px">
            <span class="shamar-quantity">{{user.likes}}</span>
          </div>
        </div>
        <div class="card-body">
          ...
          <div class="modal-body">
            <ul class="list-group list-group-flush">
              <li class="list-group-item d-flex justify-content-between align-items-center" v-for="follower in followerList">
                <img class="followers-img" :src="(follower.follower.foto != null) ? (follower.follower.foto.url) : '../assets/logo-shamar.png'" width="60px" height="60px">
          ...
          <div class="modal-body">
            <ul class="list-group list-group-flush">
              <li class="list-group-item d-flex justify-content-between align-items-center" v-for="following in followingList">
                <img class="followers-img" :src="(following.following.foto != null) ? (following.following.foto.url) : '../assets/logo-shamar.png'" width="60px" height="60px">
    ...
    <div class="container">
      <div class="row justify-content-md-center">
        <div class="col-xl-3 col-lg-3 col-md-6 post" v-for="post in postList">
